        ...
        <nav className="sticky top-0 z-50 border-b border-border bg-background/95 backdrop-blur">
          <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
            ...
            <div className="hidden md:flex gap-8">
              <a href="#packages" className="hover:text-accent transition">
                Services
              </a>
              ...
              <a href="#quote" className="hover:text-accent transition">
                Contact
              </a>
            </div>
            <a href="#quote">
        ...
        <section className="relative py-24 px-6 overflow-hidden">
          <div className="relative max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-8 text-balance">
              Clean, modern, and affordable websites that help growing
              businesses build credibility and reach customers online.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-muted-foreground">
                  Professional designs that make your business stand out and
              ...
              <div className="text-center">
                ...
                <p className="text-muted-foreground">
                  Quality web design at prices that work for small businesses
                  and startups.
                </p>
              </div>
              <div className="text-center">
                ...
                <p className="text-muted-foreground">
                  Get your website live quickly with our streamlined 5-12 day
                  delivery timeline.
                </p>
              </div>
            </div>
        ...
        <footer className="border-t border-border bg-background/50">
          <div className="max-w-7xl mx-auto py-12 px-6">
            ...
            <div className="border-t border-border pt-8 text-center text-sm text-muted-foreground">
              <p>
                &copy; {new Date().getFullYear()} LM Studios. All rights
                reserved.
              </p>
            </div>
          </div>
